 ...
 * 1. Removed unused WindowEvent import (was only used inside the
 *    duplicated SystemExit() method, which is now removed).
 * 2. Removed the duplicated SystemExit() method - now uses the shared
 *    util.WindowUtils.closeWindow().
 * 3. Replaced hardcoded "1234"/"admin" literals with named constants
...
public class Adlog extends javax.swing.JFrame {
    ...
    private void login1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_login1ActionPerformed
        ...
        if (pass.equals(AppConstants.ADMIN_PASSWORD) && name.equals(AppConstants.ADMIN_USER))
        {
            jPassword.setText(null);
            Text.setText(null);
            WindowUtils.closeWindow(this);
